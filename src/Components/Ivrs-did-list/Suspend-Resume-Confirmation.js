...
//   // Ensure your .env file has REACT_APP_API_URL set
...
//     // For example: "resumed" sends "1" and "suspended" sends "2"
//     const k1Value = status === "resumed" ? 1 : 2;

//     // Use the selected IVRS rows if provided; otherwise, fall back to selectedRows.
//     const keys =
...
//         // Update local data state to reflect the new status for selected rows.
//         setData((prevData) =>
//           prevData.map((row) =>
...
const SuspendAndResumeConfirmation = ({
  ...
  console.log(selectedIvrsRows, "srow");
